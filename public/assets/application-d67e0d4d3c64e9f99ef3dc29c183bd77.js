...
(function() {
  ...
  window.showAndHide = function(selector) {};
  ...
  window.simpleFormat = function(str) {
    return linkify(sanitize(str).replace(/\n/g, '<br />'));
  };
  ...
  $(function() {
    var flash;
    $(".one_click_select").on('click', function() {
      return $(this).select();
    });
    ...
    $(".diff-content").on("click", ".supp_diff_link", function() {
    ...
    return $(document).on("click", '.js-confirm-danger', function(e) {
      var btn, form, text;
      e.preventDefault();
      btn = $(e.target);
